...
getRegister' platform _is32Bit (CmmMachOp mop [x, y, z]) = do -- ternary MachOps
  ...
  case mop of
      ...
      MO_VF_Insert l W32  | sse4_1 -> vector_float_insert_sse l W32 x y z
                          | otherwise
                          -> sorry "Please enable the -msse4 flag"
      MO_VF_Insert l W64  -> vector_float_insert_sse l W64 x y z
  ...
  where
    ...
    vector_float_insert_sse :: Length
                            ...
                            -> NatM Register
    -- FloatX4
    vector_float_insert_sse len@4 W32 vecExpr valExpr (CmmLit (CmmInt offset _))
      = do
    ...
    -- DoubleX2
    vector_float_insert_sse len@2 W64 vecExpr valExpr (CmmLit offset)
      = do
    ...
    vector_float_insert_sse len width _ _ offset
